...
import com.example.demo.dao.HrMapper;
import com.example.demo.dao.HrRoleMapper;
import com.example.demo.pojo.Hr;
import com.example.demo.service.utils.HrUtils;
...
public class HrService implements UserDetailsService{
	...
	public boolean updateHrPasswd(String oldpass,String pass,Integer hrid) {
		...
		if(encode.matches(oldpass, hr.getPassword())) {
